...
function Pagechoose5() {
    ...
    const handleConfirm = () => {
        ...
        axios.post('http://127.0.0.1:5000/answer', {
            ans3: Array.from(selectedSymptoms).join('')
        })
        .then(response => {
            ...
            <body>
                <div className='panelmain'>
                    <div className="panelcontainer"> 
                        ...
                        <div style={{ color: '#062D62' }}>ได้ทานยาอะไรมาบ้างคะ?</div>
                        <span className="button-gap"></span>
                        <span className="button-gap"></span>
                        <button onClick={playAudio}><AiFillSound  /></button>
                        <div className="center-container">
                            <div className="button-container">
                                <button onClick={() => handleSymptomSelect("ได้ทานมา")} className={selectedSymptoms.has("ได้ทานมา") ? "selected" : ""}>ได้ทานมา</button>
                                <span className="button-gap"></span>
                                <button onClick={() => handleSymptomSelect("ไม่ได้ทาน")} className={selectedSymptoms.has("ไม่ได้ทาน") ? "selected" : ""}>ไม่ได้ทาน</button>
                            ...
                            <div style={{ margin: '20px' }}>
                                ...
                                <span className="button-gap"></span>
                                <span className="button-gap"></span>
                                <Link to="/page5"><button>พูดคำตอบ</button></Link>
                                <span className="button-gap"></span>
                                <span className="button-gap"></span>
                                <Link to="/page6"><button onClick={handleConfirm} style={{ background: '#C1FF72'  }}>ยืนยัน</button></Link>
                            </div>
                        </div>
                    </div>
                </div>
