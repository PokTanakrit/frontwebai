...
function Page9() {
    ...
    const handleFetchAudio = async () => {
        try {
            ...
            const audioData = response.data.question[7].audio;
            ...
            <body>
                <div className='panelmain'>
                    <div className="panelcontainer"> 
                        ...
                        <div style={{ color: '#062D62' }}>มีอาการรุนแรงหรือส่งผลต่อชีวิตประจำวันหรือไม่?</div>
                        ...
                        <div className="center-container">
                            ...
                            <div style={{ margin: '20px' }}>
                                <Link to="/page18"><button onClick={handleback} >ย้อนหลับ</button></Link>
                                <span className="button-gap"></span>
                                <span className="button-gap"></span>
                                ...
                                <span className="button-gap"></span>
                                <span className="button-gap"></span>
                                <Link to="/page10"><button onClick={handleConfirm} style={{ background: '#C1FF72'  }}>ยืนยัน</button></Link>
                            </div>
                        </div>
                    </div>
                </div>
